...
public class ObjectCommon : DataLoader
{
    ...
    // TODO: Clean this up asap using our new knowledge about android games
    public override void Read(ByteReader reader)
    {
        ...
        if (Context.BuildNumber >= 284)
        {
            ...
            if (Context.BuildNumber == 284 && check == 0)
            {
        ...
        else if (Context.Android)
        {
            ...
            else if (Context.BuildNumber == 288)
            {
                var size = reader.ReadInt32();
