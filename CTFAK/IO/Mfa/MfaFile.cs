...
public class MfaFile : FusionFile
{
    ...
    public MFAControls Controls = new();
    public AppMenu Menu;
    public int _windowMenuIndex;
    public Dictionary<int, int> MenuImages = new();
    public MFAValueList GlobalValues = new();
    public MFAValueList GlobalStrings = new();
    public byte[] GlobalEvents = new byte[0];
    public int GraphicMode;
    public List<int> IconImages = new();
