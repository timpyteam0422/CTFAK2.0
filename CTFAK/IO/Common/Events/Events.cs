...
public class EventGroup : DataLoader
{
    public static int IdentifierCounter; //TODO: Remove this asap. Breaks global multithreading
    ...
    public override void Read(ByteReader reader)
    {
        ...
        for (var i = 0; i < conditionCount; i++)
        {
            ...
            item.Read(reader);
            item.Identifier += IdentifierCounter;
...
public class Condition : DataLoader
{
    ...
    public override void Read(ByteReader reader)
    {
        ...
        ObjectType = Context.Old ? reader.ReadByte() : reader.ReadInt16();
        Num = Context.Old ? reader.ReadByte() : reader.ReadInt16();
